...
def test_e2e_spotify_sync_invalid_credentials(e2e_harness):
    ...
    # Should fail due to invalid Spotify credentials (but actually succeeds because credentials just aren't configured)
    e2e_harness.assert_process_succeeded(True)  # App doesn't fail when creds are missing, just skips Spotify
