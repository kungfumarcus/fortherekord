...
class TestRekordboxMetadataProcessor:
    ...
    def test_enhance_track_title_basic(self, sample_track):
        """Test basic title enhancement."""
        processor = RekordboxMetadataProcessor({})
        enhanced = processor.enhance_track_title(sample_track)
        assert enhanced.title == "Test Song - Test Artist [Am]"
        assert enhanced.artist == "Test Artist"

    def test_enhance_track_title_no_key(self, sample_track_no_key):
        """Test title enhancement without key."""
        processor = RekordboxMetadataProcessor({})
        enhanced = processor.enhance_track_title(sample_track_no_key)
